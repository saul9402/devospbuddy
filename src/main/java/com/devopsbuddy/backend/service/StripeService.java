...
public class StripeService {
	 ...
	 * 
	 * @param tokenParams    The credit card details to obtain a token. These will
	 *                       never be stored in the DB
	 ...
	 * @throws com.devopsbuddy.exceptions.StripeException If an error occurred while
